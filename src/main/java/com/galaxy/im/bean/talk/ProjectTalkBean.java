...
public class ProjectTalkBean extends PagableEntity{

	private static final long serialVersionUID = 1768577888918962444L;
	
	private long projectId;				//关联项目id
    private long fileId;				//关联附件id
	private Date viewDate;				//访谈时间
	private String viewDateStr;			//访谈时间字符串
