...
public class GSONUtil {
     ...
     * @return
     */
    public static String toJson(String code, String msg, Object obj) {
        JSONResult jsonResult=new JSONResult(code, msg, obj);
        return GSONUtil.toJson(jsonResult);
    }
    public static String toJson(String code, String msg) {
